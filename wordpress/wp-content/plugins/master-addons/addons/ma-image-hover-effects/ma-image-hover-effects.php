...
class JLTMA_Image_Hover_Effects extends Widget_Base {
    ...
    public function get_script_depends() {
        return ['imagesloaded', 'fancybox', 'font-awesome-4-shim'];
    }
    ...
    protected function register_controls() {
         ...
         */
        $this->start_controls_section( 'ma-image-hover-effect-section', [
            'label' => __( 'Effects & Image', 'master-addons' ),
        ] );
        $this->add_control( 'ma_el_main_image_effect', [
            ...
            'description' => sprintf( '20+ more effects on <a href="%s" target="_blank">%s</a>', esc_url_raw( admin_url( 'admin.php?page=master-addons-settings-pricing' ) ), __( 'Upgrade Now', 'master-addons' ) ),
        ] );
        ...
        $this->add_control( 'ma_el_main_image_size', [
        ...
        $this->add_control( 'ma_el_main_image_more_link_url', [
        ...
        $this->add_control( 'ma_el_image_popup_type', [
        ...
        $this->add_control( 'popup_saved_widget', [
        ...
        $this->add_control( 'popup_saved_section', [
        ...
        $this->add_control( 'popup_templates', [
         ...
         */
        $this->start_controls_section( 'ma_el_main_image_content_heading_section', [
         ...
         */
        $this->start_controls_section( 'ma_el_main_image_content_subheading_section', [
            'label'     => __( 'Sub Heading', 'master-addons' ),
            'condition' => [
                "ma_el_main_image_effect" => ["honey"],
            ],
        ] );
         ...
         */
        $this->start_controls_section( 'ma_el_main_image_desc_section', [
         ...
         */
        $this->start_controls_section( 'ma_el_main_image_desc_set2_heading', [
            'label'       => __( 'Description', 'master-addons' ),
            'type'        => Controls_Manager::HEADING,
        ...
        $this->add_control( 'ma_el_main_image_desc_set2_tabs', [
         ...
         */
        $this->start_controls_section( 'ma_el_main_image_social_link_section', [
        ...
        $this->add_control( 'ma_el_main_image_icon_tabs', [
            'type'        => Controls_Manager::REPEATER,
            'default'     => [
                [
        ...
        $this->add_responsive_control( 'ma_el_main_image_border_radius', [
        ...
        $this->add_responsive_control( 'ma_el_main_image_pading', [
        ...
        $this->add_responsive_control( 'ma_el_main_image_margin', [
        ...
        $this->add_responsive_control( 'ma_el_main_image_title_pading', [
            'label'       => __( 'Padding', 'master-addons' ),
            'type'        => Controls_Manager::CHOOSE,
            'options'     => [
                '1' => [
        ...
        $this->add_responsive_control( 'ma_el_main_image_title_margin', [
            'label'       => __( 'Margin', 'master-addons' ),
            'type'        => Controls_Manager::CHOOSE,
            'options'     => [
                '1' => [
        ...
        $this->add_responsive_control( 'ma_el_main_image_desc_pading', [
            'label'       => __( 'Padding', 'master-addons' ),
            'type'        => Controls_Manager::CHOOSE,
            'options'     => [
                '1' => [
        ...
        $this->add_responsive_control( 'ma_el_main_image_desc_margin', [
            'label'       => __( 'Margin', 'master-addons' ),
            'type'        => Controls_Manager::CHOOSE,
            'options'     => [
                '1' => [
        ...
        $this->add_control( 'ma_el_main_image_icon_size', [
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'ma_el_image_hover_effect_wrapper', [
            'class' => ['jltma-image-hover-effect', 'jltma-image-hover-effect-' . esc_attr( $ma_el_image_hover_sets ), 'jltma-image-hover-effect-' . esc_attr( $settings['ma_el_main_image_effect'] )],
            'id'    => 'jltma-image-hover-effect-' . $this->get_id(),
        ] );
        $this->add_render_attribute( 'ma_el_image_hover_effect_heading', [
            'class' => 'jltma-image-hover-title',
        ] );
		...
		<div <?php 
        echo $this->get_render_attribute_string( 'ma_el_image_hover_effect_wrapper' );
        ?>>

			<figure class="jltma-effect-<?php 
        echo esc_attr( $settings['ma_el_main_image_effect'] );
        ?>">

				<?php 
        if ( isset( $settings['ma_el_main_image']['id'] ) && $settings['ma_el_main_image']['id'] != "" ) {
        ...
        ?>>
							...
							<?php 
        echo $this->parse_text_editor( $settings['ma_el_main_image_title'] );
        ?>

							<?php 
        $ma_el_main_image_sub_title = array("honey");
        if ( in_array( $ma_el_main_image_effect, $ma_el_main_image_sub_title ) ) {
            ?>
								<i><?php 
            echo esc_html( $settings['ma_el_main_image_sub_title'] );
            ?></i>
							<?php 
        }
        ?>
        ...
        ?>>
						...
						<?php 
        // Social Icons Sets
        $ma_el_main_image_socials_array = array(
            "hera",
            "zoe",
            "winston",
            "terry",
        ...
        if ( in_array( $ma_el_main_image_effect, $ma_el_main_image_socials_array ) ) {
            ?>
							<p class="jltma-icon-links">
								<?php 
            foreach ( $settings['ma_el_main_image_icon_tabs'] as $index => $tab ) {
                ?>
									<a href="<?php 
                ...
                if ( $is_new || $migrated ) {
                    \Elementor\Icons_Manager::render_icon( $tab['ma_el_main_image_icon'], [
                        'aria-hidden' => 'true',
                    ] );
                } else {
                    ?>
        ...
        ?>
						<?php 
        if ( isset( $settings['ma_el_main_image_desc_set2_tabs'] ) ) {
        ...
        if ( in_array( $ma_el_main_image_effect, $ma_el_main_image_effect_array ) ) {
            ?>
							<p class="jltma-image-hover-desc">
								<?php 
            echo wp_kses_post( $settings['ma_el_main_image_desc'] );
            ?>
							</p>
						<?php 
        }
        ...
        if ( $settings['ma_el_image_hover_link_type'] == "links" && $settings['ma_el_main_image_more_link_url']['url'] != "" ) {
            ?>
						...
						<a <?php 
            echo $this->get_render_attribute_string( 'ma_el_image_hover_link' );
            ?>></a>

					<?php 
        } elseif ( ma_el_fs()->can_use_premium_code__premium_only() && $settings['ma_el_image_hover_link_type'] == "popup" ) {
            ?>
            ...
            if ( $settings['ma_el_image_popup_type'] == 'content' ) {
                ...
                if ( $settings['ma_el_image_popup_type'] == 'image' && !empty( $settings['popup_image']['url'] ) ) {
                    echo $this->render_image( $settings['popup_image']['id'], $settings );
                } else {
                    if ( $settings['ma_el_image_popup_type'] == 'section' && !empty( $settings['popup_saved_section'] ) ) {
                        echo \Elementor\Plugin::$instance->frontend->get_builder_content_for_display( $settings['popup_saved_section'] );
                    } else {
                        if ( $settings['ma_el_image_popup_type'] == 'template' && !empty( $settings['popup_templates'] ) ) {
                            echo \Elementor\Plugin::$instance->frontend->get_builder_content_for_display( $settings['popup_templates'] );
                        } else {
                            if ( $settings['ma_el_image_popup_type'] == 'widget' && !empty( $settings['popup_saved_widget'] ) ) {
